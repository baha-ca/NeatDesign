		...
		<tr>
			...
			<div id='openidLogin'>
				...
				<table class="openid-loginbox-userpass">
					<tr>
						<td>OpenID:</td>
						<td><input type="text" name="${openidIdentifier}" value="${openidPassedURL}" class="openid-identifier"/></td>
					</tr>
...
(function() { 
	...
	<g:if test='${openidPassedURL && openidPassedURL.trim() != ""}'>
	document.forms['openIdLoginForm'].submit();
	</g:if>
})();
